...
contract NFTMarketPlace is ERC721URIStorage {
    ...
    function updateListingPrice(uint256 _listingPrice) public payable onlyOwner {
        ...
        (
            owner == msg.sender,
            "only maketplace owner can update listing price."
        );
        listingPrice = _listingPrice;
    }
     
     /* Returns ths listing price of the contract*/
    ...
    function createMarketItem(uint256 tokenId, uint256 price) private {
        ...
        idToMarketItem[tokenId] = MarketItem(
            tokenId,
            payable(msg.sender),
            payable(address(this)), // means the smart contract
            price,
            false
        );
    ...
    /*Create the sale of a markettplace items*/
    ...
    function createMarketSale(uint256 tokenId) public payable 
    {
        ...
        require
        (msg.value == price,
         "Please submit the asking price in order to complete the purchasing price"
         );
    ...
    function fetchMarketItem() public view returns(MarketItem[] memory)
    {
     ...
     /* Return only items thaat a user has purchased */
    //Purchase Item
    ...
    /*Return only items a use has listed*/
    //singlw User Items
